<p align="center"><img src="src-tauri/icons/onpen.svg" width="88" alt="OnPen screen annotation app icon"></p>

# OnPen — Open-source screen annotation & live captions

**Draw on your screen. Add text. Keep teaching, presenting, or working.**

OnPen is a free, MIT-licensed desktop screen annotation tool for teachers, presenters, and developers. Write over a selected monitor with a pen, highlighter, shapes, and typed text. Switch back to clicking your apps without clearing the ink. Optional live captions are available as an experimental feature.

[한국어](README.ko.md) · **[Download for Windows](https://github.com/BAEM1N/layerpen/releases/latest)** · [User guides](Wiki/README.md) · [Report a bug](https://github.com/BAEM1N/layerpen/issues/new?template=bug_report.md) · [Contribute](CONTRIBUTING.md)

[![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)](LICENSE)
[![Release](https://img.shields.io/github/v/release/BAEM1N/layerpen)](https://github.com/BAEM1N/layerpen/releases/latest)
...
| --- | --- | --- |
| Windows x64 | [Installer EXE](https://github.com/BAEM1N/layerpen/releases/download/v0.1.0/OnPen_0.1.0_x64-setup.exe) | v0.1.0 beta |
| Windows x64 | [Portable ZIP](https://github.com/BAEM1N/layerpen/releases/download/v0.1.0/OnPen-0.1.0-windows-x64-portable.zip) | Extract, then run `OnPen.exe` |
...
[SHA-256 checksums](https://github.com/BAEM1N/layerpen/releases/download/v0.1.0/SHA256SUMS.txt) · [Release notes](https://github.com/BAEM1N/layerpen/releases/tag/v0.1.0)

Windows needs WebView2. The installer can obtain that runtime. Current builds are unsigned and have no automatic updater. Close an older OnPen instance before starting a new build. Python is **not required for drawing**; captions need [optional setup](Wiki/EN/07-live-captions.md).
...
Looking for an open-source screen annotation alternative to Epic Pen or ZoomIt? OnPen focuses on a selected-monitor overlay, typed annotations, configurable toolbars, and optional captions. It is an independent project, not affiliated with those products.
...
### Does OnPen draw over other applications?
...
### Can students open OnPen in a browser?
...
### Why is the repository named `layerpen`?

The product was renamed to **OnPen**. The existing GitHub URL and application identifier are retained for continuity. New capture defaults use `Pictures/OnPen`; legacy settings are migrated without deleting previous exports.
...
These are development priorities, not promised delivery dates. [Changelog](docs/CHANGELOG.md) · [Open issues](https://github.com/BAEM1N/layerpen/issues)
...
If OnPen is useful in your classroom or workflow, **a star helps others discover it**. Reports of what works—and what does not—are equally welcome.
