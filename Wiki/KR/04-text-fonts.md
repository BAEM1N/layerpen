...
[OnPen](../../README.md) · [Guide index](README.md) · [EN](../EN/04-text-fonts.md)

![OnPen — 텍스트와 글꼴](../assets/kr-text-fonts.jpg)
...
## 설치 글꼴과 TTF
네이티브 앱은 시스템의 표준 글꼴 폴더를 읽습니다. 새 글꼴 설치 후 OnPen을 재시작하세요. 글꼴 관리 앱에서만 활성화한 글꼴은 누락될 수 있습니다. 스크린샷의 짧은 목록은 미리보기용이며 실제 설치 글꼴 목록이 아닙니다.
