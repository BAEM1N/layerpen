...
[OnPen](../../README.ko.md) · [사용 가이드](README.md) · [English](../EN/10-classroom-sharing.md)

![OnPen 강사용 자료 공유 설정](../assets/sharing-settings.jpg)

*실제 설정 UI의 브라우저 미리보기입니다. 아래 수강생 화면은 실제 로컬 HTTP 서버에 예제 파일과 정지 예제 프레임을 넣어 캡처했습니다. 실제 교실의 다른 기기나 네이티브 화면 전송 검증을 대신하지 않습니다.*

## 강사가 자료 공개하기

1. OnPen 설정에서 **자료 공유 · Share materials**를 엽니다.
...
![예제 프레임을 표시하는 실제 OnPen 수강생 웹페이지](../assets/sharing-student.jpg)
...
- Windows 방화벽에서 필요한 사설 네트워크의 앱 접속을 허용합니다. OnPen이 방화벽이나 공유기 포트 포워딩을 자동 변경하지 않습니다.
